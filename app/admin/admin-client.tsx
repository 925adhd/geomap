...
export default function AdminClient() {
  // The /admin route itself returns a redirect-to-/ in production builds
  // (see app/admin/page.tsx), so this client-side token check is just a
  // defense-in-depth fallback for dev where someone hits /admin before
  // setting up the token via ?adminToken=…
